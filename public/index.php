 ...
 <!-- Header -->
    <header>
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                <img class="img-responsive" src="img/logo-small.png" alt="Visuel logo OmegaWebProd">
                    <!--<img class="img-responsive" src="img/profile.png" alt=""-->
                    <div class="intro-text">
                        <span class="name">Blog.OmegaWebProd</span>
            ...
            <div class="container">
                <div class="row">
                    <span class="col-lg-6">
                      ...
                      <a href="#confidential" class="portfolio-link" data-toggle="modal">Politique de confidentialité</a> | <a href="#">Admin</a>
                     </span>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-8 col-lg-offset-2">
                        <div class="modal-body">
                          ...
                          <p>L’adresse de notre site est : https://blog.omegawebblog.com</p>
                          <h2>commentaires</h2>
