...
--
-- Host: localhost:8889
-- Generation Time: Jul 25, 2022 at 05:17 PM
...
(3, 'Lebeau@exemple.fr', 'renenestpasgentil', 'René', 'Lebeau ', 'Mister', NULL, 'User', NULL),
...
(25, 'testPourgit@exemple.fr', 'lepetitpontestloin', 'git', 'git le grand', NULL, NULL, 'User', NULL),
(26, 'ty3@hy.fr', 'leplatpaysesttriste', 'ty3', 'ty34', NULL, NULL, 'User', NULL),
(27, 'testencrypt@test.fr', 'anMJ.2bLblfqw', 'tesencypy', 'tesencypy moi', NULL, NULL, 'User', NULL),
(28, 'testmoi@test.fr', 'anqNKzr0eobm.', 'test moi', 'test moi', NULL, NULL, 'User', NULL);
